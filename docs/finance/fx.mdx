...
>
  <ChapterStars chapterId="fx" showLabel />
  <ClearStarsButton chapterId="fx" />
</div>
...
## 9. Practical Lab — FX Symmetry (10 mini exercises)

<TryIt
  id="fx-lab"
  chapterId="fx"
  title="FX Volatility & Symmetry — Lab"
  intro="Implement the functions described below, then click Run tests. Each exercise has 2 tests; all ten together total 3★."
  starTotal={3}
  packWeight={0.3}
  packs={[
    {
      id: 'fwd',
      name: '⭐ FX Forward (rd − rf)',
...
def call_fx_bs(S, K, T, rd, rf, sigma):
    """FX Black–Scholes call price with two rates."""
...
def put_fx_bs(S, K, T, rd, rf, sigma):
    """FX Black–Scholes put price with two rates."""
    # TODO
    return 0.0
`,
    ...
    {
      id: 'fwd-prod',
      name: '⭐ Forward Reciprocity (Product = 1)',
...
`,
    ...
    {
      id: 'drift-foreign',
      name: '⭐ Drift Under Foreign Measure',
      detect: "def\\s+foreign_measure_drift\\s*\\(",
      question: `Implement foreign_measure_drift(rd, rf) returning (rf − rd), the drift of S under the foreign measure.`,
