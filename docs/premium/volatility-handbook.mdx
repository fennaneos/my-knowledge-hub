...
slug: /premium/volatility-handbook   # <— new URL
premium: true                        # badge via front-matter works too
badge: Premium
---
...
<div style={{
  ...
  <div style={{color:'#f2d98b', fontWeight:800, marginBottom:4}}>Premium</div>
  <div style={{color:'#dfe6ef'}}>
    Part of the advanced Volatility Handbook. <a href="/pricing">Get access</a>.
  </div>
</div>
